...
import { File, Download, Trash2, Edit2, Eye, FileText, ImageIcon, FileVideo, FileArchive } from 'lucide-react';
...
export const FileCard: React.FC<FileCardProps> = ({ file, onDelete, onEdit, onPreview }) => {
  ...
  const getIcon = () => {
    ...
    if (file.file_name.endsWith('.docx') || file.file_name.endsWith('.xlsx')) return <FileText className="w-6 h-6 text-blue-500" />;
